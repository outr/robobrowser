...
libraryDependencies ++= Seq(
  ...
  "org.seleniumhq.selenium" % "selenium-api" % "4.1.3",
  "org.seleniumhq.selenium" % "selenium-chrome-driver" % "4.1.3",
  "org.seleniumhq.selenium" % "selenium-remote-driver" % "4.1.3",
  "org.seleniumhq.selenium" % "htmlunit-driver" % "3.56.0",
  "org.seleniumhq.selenium" % "selenium-support" % "4.1.3",
